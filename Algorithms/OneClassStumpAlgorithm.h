...
namespace MultiBoost {
	...
	*/
	...
	//////////////////////////////////////////////////////////////////////////
	template <typename T> 
	float OneClassStumpAlgorithm<T>::findSingleThresholdWithInit
	...
	{ 
		...
		vector<float> bestHalfEdges(numClasses);
		vector<vector<float> > bestHalfEdgesForAllClass(numClasses);
		...
		{
			float threshold = static_cast<float>( bestPreviousSplitPos[bestClassInd]->second + 
